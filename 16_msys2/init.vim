...
"" set t_ku=(Ctrl-V,Up Arrow Key)
"" set t_kd=(Ctrl-V,Down Arrow Key)
"" set t_kl=(Ctrl-V,Left Arrow Key)
"" set t_kr=(Ctrl-V,Right Arrow Key) 
...
" 
" this line has a trouble arrow key and bs key
"
" if !s:is_nvim
"   set term=xterm
" endif
