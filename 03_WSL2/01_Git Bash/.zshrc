...
alias ~='cd /c/Program\ Files/Git/'


path+=('/c/Users/minhwasoo/.local/bin')
path+=('/c/Users/minhwasoo/.fzf/bin/')
path+=('c/Program\ Files/Git/')
path+=('c/Program\ Files/Git/bin')
path+=('c/Program\ Files/Git/mingw64/bin')
path+=('c/Program\ Files/Git/usr/local/bin')
export PATH
